...
from task_travel import task_travel
from task_coin_mall import task_coin_mall
from task_energy_center import task_energy_center
from task_energy_exchange import task_energy_exchange
from task_mail_receive import task_mail_receive
from task_ordinary_work import task_ordinary_work
from task_sign import task_sign
from task_task import task_task
from task_activity_sign import task_activity_sign
from task_update_character_json import task_update_character_json
...
def task_start(device_id, authorization):
    ...
    if client.is_login:
        ...
        client.login()
        if client.is_login:
            return task_start(device_id, authorization)
        else:
            log.error('登录失败，将在下次运行时重试！')
